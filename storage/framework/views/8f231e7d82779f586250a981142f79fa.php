...
<?php if (isset($component)) { $__componentOriginal9f64f32e90b9102968f2bc548315018c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal9f64f32e90b9102968f2bc548315018c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modal','data' => ['id' => 'modalStokKurang','title' => 'Stok Tidak Mencukupi','message' => 'Jumlah yang dimasukkan melebihi stok yang tersedia.','confirmText' => 'Oke','cancelText' => 'Batal','confirmId' => 'btnCloseStokKurang','cancelId' => 'btnCloseStokKurang2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('modal'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'modalStokKurang','title' => 'Stok Tidak Mencukupi','message' => 'Jumlah yang dimasukkan melebihi stok yang tersedia.','confirmText' => 'Oke','cancelText' => 'Batal','confirmId' => 'btnCloseStokKurang','cancelId' => 'btnCloseStokKurang2']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal9f64f32e90b9102968f2bc548315018c)): ?>
<?php $attributes = $__attributesOriginal9f64f32e90b9102968f2bc548315018c; ?>
